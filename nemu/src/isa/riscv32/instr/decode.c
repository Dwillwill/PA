...
def_THelper(main) {
  ...
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 00100 11", I     , logic_arithmetic);
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 11100 11", I     , raise_exception);
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 00101 11", U     , auipc);
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 11011 11", J     , jal);
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 11001 11", I     , jalr);
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 01100 11", R     , reg_op);
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 11000 11", B     , jump_B);
